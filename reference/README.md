...
- `image.png` — Blockradar's signing-architecture diagram (encrypted seed → AES-256-GCM →
  BIP44 derive → sign → secure memory wipe).
- `image copy.png`, `Pasted image.png` — Blockradar dashboard / guides screenshots.
